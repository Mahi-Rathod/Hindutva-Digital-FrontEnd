  ...
  return (
    <header
      className={`sticky m-auto max-w-[1488px] border-solid border-b-[1px] p-2 w-full flex md:justify-between items-center z-50 top-0
                ${
                  isLight
                    ? "bg-white border-gray-500 text-slate-900"
                    : "bg-gradient-to-r from-slate-900 bg-slate-800 border-slate-700 text-white "
                }`}
    >
      ...
      {!isAdmin ? (
        <>
          ...
          <div className="relative hidden md:flex gap-[3rem] w-[80%] items-center px-10 font-sans text-md">
            ...
            <div
              className={`absolute top-12 left-[6.7rem] flex flex-col ${
                isLight
                  ? "bg-white"
                  : "bg-gradient-to-b from-slate-800 to-slate-900"
              }  ${
                !activeLink.isVisible ? "h-0" : "h-[18rem]"
